...
const campWeeks = [
  {
    label: 'Week 1',
    items: [
      { type: 'photo', src: '/media/summer-camp/IMG_1353.jpeg' },
      { type: 'photo', src: '/media/summer-camp/IMG_1354.jpeg' },
      { type: 'photo', src: '/media/summer-camp/IMG_1355.jpeg' },
      { type: 'photo', src: '/media/summer-camp/IMG_1360.jpeg' },
      { type: 'photo', src: '/media/summer-camp/IMG_1363.jpeg' },
      { type: 'video', src: '/media/summer-camp/IMG_1364.MOV' },
      { type: 'video', src: '/media/summer-camp/IMG_1365.mov' },
      { type: 'photo', src: '/media/summer-camp/IMG_1366.jpeg' },
      { type: 'photo', src: '/media/summer-camp/IMG_1367.jpeg' },
      { type: 'video', src: '/media/summer-camp/IMG_1368.mov' },
      { type: 'video', src: '/media/summer-camp/IMG_1369.mov' },
      { type: 'photo', src: '/media/summer-camp/IMG_1370.jpeg' },
      { type: 'photo', src: '/media/summer-camp/IMG_1371.jpeg' },
      { type: 'photo', src: '/media/summer-camp/IMG_1372.jpeg' },
      { type: 'photo', src: '/media/summer-camp/IMG_5192.JPEG' },
      { type: 'photo', src: '/media/summer-camp/IMG_5193.JPEG' },
      { type: 'photo', src: '/media/summer-camp/IMG_5194.JPEG' },
      { type: 'photo', src: '/media/summer-camp/IMG_5195.JPEG' },
      { type: 'photo', src: '/media/summer-camp/IMG_5196.JPEG' },
      { type: 'video', src: '/media/summer-camp/IMG_5197.MOV' },
    ],
  },
]
